...
void extractImage(int imgX, int imgY, int imgW, int imgH,
                  const std::string &structName, std::ofstream &headerStream,
  ...
  // Header
  headerStream << "#define " << structName << "_W " << imgW << "\n"
               << "#define " << structName << "_H " << imgH << "\n"
               << "extern struct Image " << structName << ";\n";

  // Impl
  // ImageData
  implStream << "static USHORT CHIPMEM " << structName << "_imageData[] = {\n";
...
int main(int argc, char **argv) {
  ...
  headerStream << kLicense << "// This file was generated from " << filename
               << "\n"
               << "// DO NOT MODIFY!\n\n"
  ...
  implStream << kLicense << "// This file was generated from " << filename
             << "\n"
             << "// DO NOT MODIFY!\n\n"
             << "#include <intuition/intuition.h>\n"
             << "#include \"images.h\"\n\n"
  ...
  extractImage(11 * 16, top, 16, 16, "imgTileMineWrong", headerStream,
               implStream);
  extractImage(12 * 16, top, 16, 16, "imgTileMineExploded", headerStream,
               implStream);
  extractImage(13 * 16, top, 16, 16, "imgTileMaybe", headerStream, implStream);
  extractImage(14 * 16, top, 16, 16, "imgTileFlagged", headerStream,
               implStream);
  ...
  // checkbox
  extractImage(0 * 7, top, 7, 7, "checkboxUnselected", headerStream,
               implStream);
